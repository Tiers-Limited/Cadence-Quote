...
const PROPOSAL_TEMPLATES = [
  {
    ...
    description:
      'Traditional layout with formal typography and structured sections (Current Default)',
  ...
  },
  {
    ...
    name: 'Modern/Minimal',
    description:
      'Clean layout with ample whitespace and contemporary design elements',
  ...
  },
  {
    ...
    description:
      'Expanded sections for specifications, terms, and detailed breakdowns',
  ...
  },
  {
    ...
    description:
      'Concise layout focusing on essential pricing and product information',
          ...
          <div class="page">
            <div>
              <div class="header">
                ...
                <div>
                  ...
                  <div class="small muted">Phone: ${
                    sampleData.company.phone
                  } • Email: ${sampleData.company.email}</div>
                  <div class="small muted">${
                    sampleData.company.addressLine1
                  }, ${sampleData.company.addressLine2}</div>
                </div>
              </div>

              <div class="title">Project Proposal</div>
              <div class="kv small"><span class="label">Invoice:</span> ${
                sampleData.proposal.invoiceNumber
              }</div>
              <div class="kv small"><span class="label">Date:</span> ${
                sampleData.proposal.date
              }</div>
              <div class="kv small"><span class="label">Customer:</span> ${
                sampleData.proposal.customerName
              }</div>
              <div class="kv small"><span class="label">Project Address:</span> ${
                sampleData.proposal.projectAddress
              }</div>

              <div class="section-title">Introduction</div>
              <div class="small pre">${
                sampleData.introduction.welcomeMessage
              }</div>
              <div class="small pre muted" style="margin-top:6px;">${
                sampleData.introduction.aboutUsSummary
              }</div>
            ...
            <div>
              ...
              <div class="card small">
                <div class="kv"><span class="label">Selected Option:</span> ${
                  sampleData.proposal.selectedOption
                }</div>
              ...
              <div class="small pre"><span class="label">Client:</span> ${
                sampleData.responsibilities.client
              }</div>
              <div class="small pre" style="margin-top:6px;"><span class="label">Contractor:</span> ${
                sampleData.responsibilities.contractor
              }</div>

              <div class="section-title">Acceptance</div>
              <div class="small pre">${
                sampleData.acceptance.acknowledgement
              }</div>
...
${sampleData.payment.paymentTermsText}</div>
  ...
  const fetchCurrentSettings = async () => {
    ...
    try {
      ...
      if (response.success && response.data) {
        setSelectedTemplate(
          response.data.selectedProposalTemplate || 'classic-professional'
        )
        setTemplateSettings({
          ...templateSettings,
  ...
  return (
    <div className='space-y-6'>
      <div>
        ...
        <Text type='secondary'>
          Choose and customize your proposal template to match your brand and
          presentation style.
        </Text>
      </div>
                ...
                <Space direction='vertical' className='w-full' size='middle'>
                  <div className='flex justify-between items-center py-1'>
                    ...
                    <Switch
                      ...
                      onChange={checked =>
                        handleSettingChange('showCompanyLogo', checked)
                      }
                      size='default'
                    />
                  </div>
                  <div className='flex justify-between items-center py-1'>
                    ...
                    <Switch
                      ...
                      onChange={checked =>
                        handleSettingChange('showAreaBreakdown', checked)
                      }
                      size='default'
                    />
                  </div>
                  <div className='flex justify-between items-center py-1'>
                    ...
                    <Switch
                      ...
                      onChange={checked =>
                        handleSettingChange('showProductDetails', checked)
                      }
                      size='default'
                    />
                  </div>
                  <div className='flex justify-between items-center py-1'>
                    ...
                    <Switch
                      ...
                      onChange={checked =>
                        handleSettingChange('showWarrantySection', checked)
                      }
                      size='default'
                    />
                  </div>
            ...
            <Col xs={24} md={16}>
              ...
              <div className='space-y-1'>
                ...
                <Text className='text-sm text-gray-600 block'>
                  ...
                  {
                    COLOR_SCHEMES.find(
                      s => s.value === templateSettings.colorScheme
                    )?.label
                  }
                </Text>
              </div>
